...
<TABLE width="100%" class="position">
	<TR>
		<TD><s:text name="notice_edit.page.position" /></TD>
		<TD align="right"><a href="notice!list.do"><s:text name="notice_edit.page.back" /></a></TD>
		<TD width="20"></TD>
	</TR>
</TABLE>

<s:form name="form1" action="noticeedit!update.do" method="post">
