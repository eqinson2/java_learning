...
<TABLE width="100%" class="position">
	<TR>
		<TD><s:text name="meeting_add.page.position" /></TD>
		<TD align="right"><a href="meeting!list.do"><s:text name="meeting_add.page.back" /></a></TD>
		<TD width="20"></TD>
	</TR>
</TABLE>

<s:form name="form1" action="meetingadd!insert.do" method="post">
