...
<TABLE width="100%" class="position">
	<TR>
		<TD><s:text name="sms.page.position" /></TD>
		<TD align="right"><a href="sms!add.do"><s:text name="sms.page.add" /></a></TD>
		<TD width="20"></TD>
	</TR>
</TABLE>
...
<TABLE border="0" width="100%">
	<TR class="tableheader">
		<TD><s:text name="sms.page.sender" /></TD>
		<TD><s:text name="sms.page.message" /></TD>
		<TD><s:text name="sms.page.sender" /></TD>
		<TD><s:text name="sms.page.isread" /></TD>
	...
	<TR>
		...
		<TD><a href='sms!read.do?id=<s:property value="id"/>'><s:text name="sms.page.read" /></a>
		<a href="sms!delete.do?id=<s:property value="id"/>"><s:text name="button.delete" /></a></TD>
	</TR>
	</s:iterator>
</TABLE>
...
<TABLE border="0" width="100%" class="pager">
	<TR>
	<s:form action="sms!list.do" method="post" name="form1">
