...
<TABLE width="100%" class="position">
	<TR>
		<TD><s:text name="worklog_add.page.position" /></TD>
		<TD align="right"><a href="worklog!list.do"><s:text name="worklog_add.page.back" /></a></TD>
		<TD width="20"></TD>
	</TR>
</TABLE>

<s:form name="form1" action="worklogadd!insert.do" method="post">
