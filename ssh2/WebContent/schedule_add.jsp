...
<TABLE width="100%" class="position">
	<TR>
		<TD><s:text name="schedule_add.page.position" /></TD>
		<TD align="right"><a href="schedule!list.do"><s:text name="schedule_add.page.back" /></a></TD>
		<TD width="20"></TD>
	</TR>
</TABLE>

<s:form name="form1" action="scheduleadd!insert.do" method="post">
